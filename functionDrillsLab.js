...
console.log(exclaimThree('ridge'))
...
*/
//CODE HERE
let myEmail = 'ridgechristensen28@gmail.com'
...
//CODE HERE
function maxChocholateFrogs(number) {
 let frogPrice = 3;
 let frogsBought = number / frogPrice;
 return frogsBought;
}
console.log(maxChocholateFrogs(4));
////////////////// PROBLEM 20 ////////////////////
/*
...
//CODE HERE
function maxChocholateFrogs2(number) {
  let frogPrice = 3;
  let frogsBought = 0;
  while (number >= frogPrice) {
    number -= frogPrice;
    frogsBought++;
  }
  return frogsBought;
}
let totalFrogs2 = maxChocholateFrogs2(4);
...
console.log(isItAccending(sampleArray));
////////////////// PROBLEM 22 ////////////////////
...
let bathtubScope = ['duck','nautical,sailorDuck']
